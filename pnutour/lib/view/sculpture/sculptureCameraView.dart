...
class sculptureCamera extends StatefulWidget {
  @override
  _sculptureCameraState createState() => _sculptureCameraState();
}

class _sculptureCameraState extends State<sculptureCamera> {
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    errorMessage.isNotEmpty ? errorMessage : '조형물을 비추고 검색버튼을 눌러주세요',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 15.0,
                  ...
                  try {
                    ...
                    if (response.statusCode == 200) {
                      ...
                      if (response.data['label']!=null) {
                        ...
                        setState(() {
                          isLoading = false; // 로딩 상태 해제
                          errorMessage = '조형물인식실패, 다시 시도해주세요.';
                        });
                      }
                    }
                    else {
